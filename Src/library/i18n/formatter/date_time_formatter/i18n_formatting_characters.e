...
seconds_padded : CHARACTER is '5'
	--  The second as a decimal number (range 00 to 60).
second_fraction_padded : CHARACTER is '6'
	--  First digit of fractional second
second_fraction : CHARACTER is '7'
	-- First seven digits of fractional second, if = 0 empty string
am_pm_1 : CHARACTER is '8'
	--  One-character time marker string. (Am/pm -> a/p)
am_pm_lowercase: CHARACTER is	'9'
