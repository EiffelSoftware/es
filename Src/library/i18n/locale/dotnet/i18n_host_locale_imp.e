...
feature -- Date and time formatting
	...
	get_long_date_format: STRING_32 is
		do
			Result :=  convert_format_string (culture_info.date_time_format.long_date_pattern)
		ensure
			result_exists: Result /= Void
		end
	...
	get_long_time_format : STRING_32 is
			--
		do
			Result := convert_format_string (culture_info.date_time_format.long_time_pattern)
		ensure
			result_exists: Result /= Void
		end
	...
	get_short_time_format : STRING_32 is
			--
		do
			Result := convert_format_string (culture_info.date_time_format.short_time_pattern)
		ensure
			result_exists: Result /= Void
		end
	...
	get_short_date_format : STRING_32 is
			--
		do
			Result := convert_format_string (culture_info.date_time_format.short_date_pattern)
		ensure
			result_exists: Result /= Void
		end
	...
	get_date_time_format : STRING_32 is
		...
		do
			Result := convert_format_string (culture_info.date_time_format.full_date_time_pattern)
		end

	get_month_day_format : STRING_32 is
			-- pattern with month and day
		do
			Result := convert_format_string (culture_info.date_time_format.month_day_pattern)
		end
	...
	get_rfc1123_format : STRING_32 is
		...
		do
			Result := convert_format_string (culture_info.date_time_format.rfc1123_pattern)
		end
	...
	get_sortable_date_time_format: STRING_32 is
		...
		do
			Result := convert_format_string (culture_info.date_time_format.sortable_date_time_pattern)
		end
	...
	get_universal_sortable_date_time_format: STRING_32 is
		...
		do
			Result := convert_format_string (culture_info.date_time_format.universal_sortable_date_time_pattern)
		end
			...
			loop
				...
				elseif l_char = '\' then
					...
					when ':' then
							...
							Result.append (get_time_separator)
					when '/' then
								-- The default date separator defined in DateSeparator.
							Result.append (get_date_separator)
					when 'z', 'k', 'g' then
