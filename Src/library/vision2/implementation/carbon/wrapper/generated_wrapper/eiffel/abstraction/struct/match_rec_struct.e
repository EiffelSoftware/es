...
class MATCH_REC_STRUCT

inherit

	EWG_STRUCT

	MATCH_REC_STRUCT_EXTERNAL
		export
			{NONE} all
		end
...
feature {ANY} -- Member Access
	...
	set_matchdata (a_value: INTEGER) is
			-- Set member `matchData'
		require
			exists: exists
		do
			set_matchdata_external (item, a_value)
		ensure
			a_value_set: a_value = matchdata
		end
