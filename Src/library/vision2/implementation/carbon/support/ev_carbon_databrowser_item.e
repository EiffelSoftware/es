...
feature -- Databrowser item features
	...
	child_array: ARRAYED_LIST [EV_ANY] is
			--
		do
	...
	add_item_and_children_to_parent_tree (a_parent_tree: EV_CARBON_DATABROWSER; a_parent_node: EV_CARBON_DATABROWSER_ITEM; a_index: INTEGER)  is
