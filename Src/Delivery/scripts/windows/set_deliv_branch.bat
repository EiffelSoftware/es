...
if not defined DEFAULT_ES_ROOT set DEFAULT_ES_ROOT=https://gitlab.com/eiffelsoftware/es.git
set DEFAULT_ES_BRANCH=Eiffel_%STUDIO_VERSION_MAJOR_MINOR%

if not defined DEFAULT_ISE_SVN set DEFAULT_ISE_SVN=svn://svn.ise/ise_svn/branches/Eiffel_%STUDIO_VERSION_MAJOR_MINOR%
