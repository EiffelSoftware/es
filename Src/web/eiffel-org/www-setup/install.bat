...
:: Default values
set ISE_MAJOR_MINOR_LATEST=24.05
set ISE_BUILD_LATEST=107822

set ISE_MAJOR_MINOR_NIGHTLY=24.05
set ISE_BUILD_NIGHTLY=107822

set ISE_MAJOR_MINOR_BETA=24.05
set ISE_BUILD_BETA=107822
