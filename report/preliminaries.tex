...
In the following we will describe our example application, which will be used throughout the report, in detail.
...
\begin{description}
 ...
 \item [OUTCALLRET] Events that are triggered when returning from outcalls
 \item [INCALLRET] Events that are triggered when returning from incalls
\end{description}
